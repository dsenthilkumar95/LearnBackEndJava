...
public class SubstringConcatedEfficient {
    ...
    public static void main(String[] args) {
        SubstringConcatedEfficient subObj = new SubstringConcatedEfficient();
        String[] input = {"foo","bar"};
        List<Integer> answers = subObj.findSubstring("foofoofoobar", input);
